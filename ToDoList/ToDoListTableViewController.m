...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    cell.imageView.image = [UIImage imageNamed:@"TimeOut.jpg"];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    [self showTestViewController : tappedItem];
    
}
-(void)showTestViewController: (ToDoItem *)tappedItem{
    ...
    viewController.passedInValue = tappedItem.itemName;
